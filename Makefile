default:
	...
	gcc pubkey_calculator.c -march=native libsecp256k1.a -lgmp -O3 -o p
	gcc pubkey_cloning.c random.c bitrange.c -march=native libsecp256k1.a -lgmp -Wall -Wextra -O3 -o pc
